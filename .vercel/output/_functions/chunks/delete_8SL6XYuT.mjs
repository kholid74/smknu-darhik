...
//#region src/pages/admin/guru/delete.astro
...
var $$Delete = createComponent(async ($$result, $$props, $$slots) => {
	...
	if (Astro.request.method === "POST") {
		...
		if (id) await db.teacher.delete({ where: { id } }).catch(() => {});
	}
	return Astro.redirect("/admin/guru");
}, "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/guru/delete.astro", void 0);
var $$file = "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/guru/delete.astro";
var $$url = "/admin/guru/delete";
//#endregion
//#region \0virtual:astro:page:src/pages/admin/guru/delete@_@astro
