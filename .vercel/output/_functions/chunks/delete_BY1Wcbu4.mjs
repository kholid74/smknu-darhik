...
//#region src/pages/admin/faq/delete.astro
...
var $$Delete = createComponent(async ($$result, $$props, $$slots) => {
	...
	if (Astro.request.method === "POST") {
		...
		if (id) await db.faq.delete({ where: { id } }).catch(() => {});
	}
	return Astro.redirect("/admin/faq");
}, "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/faq/delete.astro", void 0);
var $$file = "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/faq/delete.astro";
var $$url = "/admin/faq/delete";
//#endregion
//#region \0virtual:astro:page:src/pages/admin/faq/delete@_@astro
