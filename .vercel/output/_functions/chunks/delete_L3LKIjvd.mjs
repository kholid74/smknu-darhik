...
//#region src/pages/admin/mitra/delete.astro
...
var $$Delete = createComponent(async ($$result, $$props, $$slots) => {
	...
	if (Astro.request.method === "POST") {
		...
		if (id) await db.partner.delete({ where: { id } }).catch(() => {});
	}
	return Astro.redirect("/admin/mitra");
}, "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/mitra/delete.astro", void 0);
var $$file = "/Users/kholidputra/workspace/pribadi/projects/smk-darulhikam/website/src/pages/admin/mitra/delete.astro";
var $$url = "/admin/mitra/delete";
//#endregion
//#region \0virtual:astro:page:src/pages/admin/mitra/delete@_@astro
